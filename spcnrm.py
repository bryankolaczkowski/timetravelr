#===============================================================================
# Adapted from: Copyright 2020 The TensorFlow Authors. All Rights Reserved.
#
...
class SpecNorm(tf.keras.layers.Wrapper):
  ...
  def __init__(self, layer: tf.keras.layers, power_iterations=1, **kwargs):
    super(SpecNorm, self).__init__(layer, **kwargs)
  ...
  def get_config(self):
    config = super(SpecNorm, self).get_config()
    config.update({
